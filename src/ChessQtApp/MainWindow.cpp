...
void MainWindow::updateBoardUI() {
    ...
    for (int row = 0; row < 8; ++row) {
        for (int col = 0; col < 8; ++col) {
            ...
            switch (piece) {
            case WP: iconPath = ":/pieces/white_pawn.png"; break;
            case WR: iconPath = ":/pieces/white_rook.png"; break;
            case WN: iconPath = ":/pieces/white_knight.png"; break;
            case WB: iconPath = ":/pieces/white_bishop.png"; break;
            case WQ: iconPath = ":/pieces/white_queen.png"; break;
            case WK: iconPath = ":/pieces/white_king.png"; break;

            case BP: iconPath = ":/pieces/black_pawn.png"; break;
            case BR: iconPath = ":/pieces/black_rook.png"; break;
            case BN: iconPath = ":/pieces/black_knight.png"; break;
            case BB: iconPath = ":/pieces/black_bishop.png"; break;
            case BQ: iconPath = ":/pieces/black_queen.png"; break;
            case BK: iconPath = ":/pieces/black_king.png"; break;
